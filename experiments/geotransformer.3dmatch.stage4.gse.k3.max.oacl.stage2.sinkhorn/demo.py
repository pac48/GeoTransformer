    ...
    torch.onnx.export(model, args=(
        ...
        subsampling_2, upsampling_0, upsampling_1, upsampling_2),
                      ...
                      dynamic_axes={'points_0': {0: 'num_points_0'},  # variable length axes
                                    ...
                                    'neighbors_0': {0: 'num_points_0', 1: 'dynamic'},
                                    'neighbors_1': {0: 'num_points_1', 1: 'dynamic'},
                                    'neighbors_2': {0: 'num_points_2', 1: 'dynamic'},
                                    'neighbors_3': {0: 'num_points_3', 1: 'dynamic'},
                                    'subsampling_0': {0: 'num_points_0', 1: 'dynamic'},
                                    'subsampling_1': {0: 'num_points_1', 1: 'dynamic'},
                                    'subsampling_2': {0: 'num_points_2', 1: 'dynamic'},
                                    'upsampling_0': {0: 'num_points_0', 1: 'dynamic'},
                                    'upsampling_1': {0: 'num_points_1', 1: 'dynamic'},
                                    'upsampling_2': {0: 'num_points_2', 1: 'dynamic'},
                                    },
